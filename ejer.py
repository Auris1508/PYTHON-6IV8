...
def abrir_ventana_principal():
    ...
    def ej1(padre):
        ...
        def calcular():
            ...
            entry_nombre.delete(0, "end"); entry_sueldo.delete(0, "end")
    ...
    def ej2(padre):
        ...
        def registrar():
            ...
            entry_nombre.delete(0, "end"); entry_edad.delete(0, "end"); entry_juegos.delete(0, "end")
    ...
    def ej3(padre):
        compras = []
        DESCUENTOS = {"octubre": 0.15, "diciembre": 0.20, "julio": 0.10}
        ...
        def registrar():
            ...
            entry_nombre.delete(0, "end"); entry_mes.delete(0, "end"); entry_importe.delete(0, "end")
    ...
    def ej8(padre):
        ...
        def agregar():
            ...
            if numero == 0:
                finalizar(); return
            numeros.append(numero); suma[0] += numero
        ...
        def finalizar():
            ...
            numeros.clear(); suma[0] = 0; entry_num.delete(0, "end")
    ...
    def ej9(padre):
        numeros = []; suma = [0]; activo = [True]; LIMITE = 100
...
def main():
    ...
    tk.Label(root, text="Iniciar Sesion", font=("Arial", 14, "bold"),
             bg="#4a90d9", fg="white", pady=8).pack(fill="x")

    marco = tk.Frame(root, bg="#f0f0f0", padx=20, pady=10)
    marco.pack(fill="both", expand=True)

    tk.Label(marco, text="Usuario:", bg="#f0f0f0", font=("Arial", 11)).grid(
        row=0, column=0, sticky="w", pady=4)
    entry_user = tk.Entry(marco, font=("Arial", 11))
    entry_user.grid(row=0, column=1, sticky="ew", padx=(8, 0))

    tk.Label(marco, text="Contraseña:", bg="#f0f0f0", font=("Arial", 11)).grid(
        row=1, column=0, sticky="w", pady=4)
    entry_pass = tk.Entry(marco, font=("Arial", 11), show="*")
    entry_pass.grid(row=1, column=1, sticky="ew", padx=(8, 0))

    marco.columnconfigure(1, weight=1)

    lbl_msg = tk.Label(marco, text="", fg="red", bg="#f0f0f0", font=("Arial", 10))
    lbl_msg.grid(row=2, column=0, columnspan=2, pady=(4, 0))
    ...
    entry_user.bind("<Return>", login)
    entry_pass.bind("<Return>", login)

    tk.Button(marco, text="Ingresar", command=login,
              bg="#4a90d9", fg="white", font=("Arial", 11),
              relief="flat", padx=10).grid(row=3, column=0, columnspan=2, pady=8)
